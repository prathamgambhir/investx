  ...
  return (
    ...
    <div className="relative flex min-h-screen flex-col bg-background text-foreground transition-colors duration-300">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_25%,rgba(0,163,255,0.4),rgba(255,255,255,0))] dark:bg-[radial-gradient(circle_at_50%_25%,rgba(120,119,198,0.3),rgba(0,0,0,0.9))]" />
      </div>
